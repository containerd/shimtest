...
// rootfs.
var testbinCommands = []string{"forever", "burstexit", "cat", "date", "echo", "echosrv", "exit", "hashverify", "host", "layercheck", "looptest", "ls", "memhog", "nc", "pidscan", "shmread", "shmwrite", "tickexit"}
